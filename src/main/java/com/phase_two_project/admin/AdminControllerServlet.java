package com.phase_two_project.admin;
...
import com.phase_two_project.models.Student;
import com.phase_two_project.models.Subject;
import com.phase_two_project.models.Teacher;
import com.phase_two_project.models.Class;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (!getCookies(request, response) && (!command.equals("LOGIN"))) {
				...
				response.sendRedirect("/Phase_Two_Projec/login.jsp");
			}
